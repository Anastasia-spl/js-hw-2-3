...
console.log('Proin sociis natoque et magnis parturient montes mus'.split(' '));
console.log(typeof('Proin sociis natoque et magnis parturient montes mus'.split(' ')));

console.log('Proin sociis natoque et magnis parturient montes mus'.split(' ').length);
